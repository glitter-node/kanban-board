    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-border bg-section text-primary-foreground shadow-sm focus:ring-primary" name="remember">
                <span class="ms-2 text-sm text-ui-text-secondary">{{ __('Remember me') }}</span>
            </label>
        </div>
