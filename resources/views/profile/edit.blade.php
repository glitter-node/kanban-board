                ...
                <x-layout.stack space="6">
                    ...
                    <div class="ui-panel p-4 sm:rounded-lg sm:p-8">
                        <div class="max-w-xl" x-data="{ theme: localStorage.getItem('darkMode') === 'true' ? 'dark' : 'light' }">
                            <section>
                                <header>
                                    <h2 class="text-lg font-medium text-ui-text-primary">Theme Settings</h2>
                                    <p class="mt-1 text-sm text-ui-text-secondary">Choose a display theme.</p>
                                </header>
                                ...
                                <x-layout.grid :lg="null" class="mt-6" md="2">
                                    <button @click="theme = 'light'; $store.darkMode.on = false; localStorage.setItem('darkMode', 'false')"
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="text-sm font-medium text-ui-text-primary">Light</span>
                                        </div>
                                    </button>
                    ...
                    <div class="ui-panel p-4 sm:rounded-lg sm:p-8">
                        <div class="max-w-xl" x-data="{
                            ...
                            <section>
                                <header>
                                    <h2 class="text-lg font-medium text-ui-text-primary">Notification Settings</h2>
                                    <p class="mt-1 text-sm text-ui-text-secondary">Choose which notifications you want to receive.</p>
                                </header>
