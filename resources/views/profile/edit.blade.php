                        ...
                        <div class="max-w-xl" x-data="{ theme: $store.theme.current }">
                            <section>
                                <header>
                                    ...
                                    <p class="mt-1 text-sm text-muted-foreground">Choose a display theme.</p>
                                </header>
                        ...
                        <div class="max-w-xl" x-data="{
                            ...
                            <section>
                                <header>
                                    ...
                                    <p class="mt-1 text-sm text-muted-foreground">Choose which notifications you want to receive.</p>
                                </header>
